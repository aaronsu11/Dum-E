...
import numpy as np
from galaxea.codec import MAX_MESSAGE, packb, unpackb
from galaxea.modalities import CODEC_PARTS, validate_codec_presence
...
class Runtime:
    def __init__(self, checkpoint_root):
        ...
        manifest = json.loads(Path("/app/checkpoint-manifest.json").read_text())
