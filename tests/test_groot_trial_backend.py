...
def test_calibrated_roundtrip_native_horizon_and_camera_roles(tmp_path, monkeypatch):
    ...
    state = backend.scales * np.array([100, -100, 50, -50, 25, 40])
