...
from policy.so101_contract import to_arm_frame, to_model_frame
from policy_lab.pi05_so101 import JOINT_NAMES, validate_config, verify_checkpoint
...
def test_factory_selection_is_explicit_and_uses_common_configuration(monkeypatch):
    ...
    assert isinstance(backend, Pi05SO101PolicyBackend)
